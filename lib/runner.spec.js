...
test('proxy captures update into plan: length', (t) => {
    const row = {
        id: 1,
        type: 'VariableDeclaration',
        file: 'index.js',
...
test('proxy captures update into plan: op', (t) => {
    const row = {
        id: 1,
        type: 'VariableDeclaration',
        file: 'index.js',
...
test('proxy captures update into plan: key', (t) => {
    const row = {
        id: 1,
        type: 'VariableDeclaration',
        file: 'index.js',
...
test('proxy captures update into plan: value', (t) => {
    const row = {
        id: 1,
        type: 'VariableDeclaration',
        file: 'index.js',
