...
const isSectionCall = (node) => node.type === 'CallExpression' && node.callee.type === 'Identifier' && node.callee.name === 'section';
...
export const filter = (path) => {
    ...
    return !(body.type === 'CallExpression' && isSectionCall(body));
};
