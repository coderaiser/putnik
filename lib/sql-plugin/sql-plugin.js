...
import {loadDetectorPlugin} from './detector-plugin.js';
...
export const loadPlugin = (filePath) => filePath.endsWith('.js') ? loadDetectorPlugin(filePath) : loadSqlPlugin(filePath);
